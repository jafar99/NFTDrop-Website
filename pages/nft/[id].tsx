...
function NFTDropPage({ collection }: Props) {
  ...
  const nftDrop = useNFTDrop(collection.address)
    ...
    <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
        ...
        {address &&(
            <p className="text-center text-sm text-rose-400">You're logged in with wallet {address.substring(0,5)}...
  ...
  <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-8">
      ...
      {loading ? (
        ...
        <p className="pt-2text-xl text-green-500 animate-pulse"> Loading Supply Count....</p>
      ):(

        <p className="pt-2text-xl text-green-500"> {claimedSupply} / {totalSupply?.toString()}    NFT's claimed</p>
  ...
  {/* <button  disabled={loading || claimedSupply === totalSupply?.toNumber() || !address} 
    className="mt-10 h-16 w-full rounded-full bg-red-600 text-white font-bold  disabled:bg-grey-400">
     Mint NFT(0.01 ETH)
  </button> */}
